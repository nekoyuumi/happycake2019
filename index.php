...
$query2 = $db->query("SELECT * FROM products Order By created_at DESC LIMIT 5");
   ...
   <div id="top">
       <div class="container">
           <div class="col-md-6 offer" data-animate="fadeInDown">
               <a href="frontend/register.php" class="btn btn-success btn-sm" data-animate-hover="shake">前往加入會員</a>  <a href="frontend/register.php">立即取得200元購物金!</a>
           </div>
           <div class="col-md-6" data-animate="fadeInDown">
               <ul class="menu">
               <?php if(isset($_SESSION['member']) && $_SESSION['member'] !=null) { ?>
                    <li style="color:#FFF"><?php echo $_SESSION['member']['name'] ?>, 您好 , <a href="frontend/customer-account.php" >會員專區</a>
                   </li>
                    <li>
           ...
           <div class="modal-dialog modal-sm">
              ...
              <div class="modal-content">
                   ...
                   <div class="modal-body">
                       <form action="frontend/check_member.php" method="post">
...
_________________________________________________________ -->
           ...
           <div class="navbar-collapse collapse" id="navigation">
               ...
               <ul class="nav navbar-nav navbar-left">
                   ...
                   <li class="dropdown yamm-fw">
                       <a href="frontend/product_list.php" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">產品介紹 <b class="caret"></b></a>
                           ...
                           <li>
                               <div class="yamm-content">
                                   <div class="row">
                                    ...
                                    <a href="frontend/product_list_filter.php?product_categoryID=<?php echo $category['product_categoryID']; ?>">
        ...
        <div id="content">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        <div class="item">
                            <img class="img-responsive" src="uploads/products/wood-food-bread.jpg" alt="" style="width:1000px">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="uploads/products/sweet-macaron-dessert.jpg" alt="" style="width:1000px">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="uploads/products/8562011138_27c590f525_c.jpg" alt="" style="width:1000px">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="uploads/products/36898524176_3506cc6cfd_c.jpg" alt="" style="width:1000px">
                        </div>
                    </div>
                    <!-- /#main-slider -->
                </div>
 ...
 _________________________________________________________ -->
            ...
            <div class="box text-center" data-animate="fadeInUp">
                <div class="container">
                    <div class="col-md-12">
                        <h3 class="text-uppercase">追蹤我們的粉絲專頁</h3>

                        <p class="lead">想要知道最新消息 <a href="blog.php">來粉絲團看看吧！</a>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <?php foreach($news as $data){ ?>
                        <div class="col-sm-6">
                            ...
                            <div class="post">
                                ...
                                <p class="author-category"><a href="frontend/news.php?newsID=<?php echo $data['newsID'] ?>"><i class="fa fa-calendar-o"></i><?php echo $data['published_at']; ?></a>
                                </p>
                                <hr>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <a href="frontend/product_list_filter.php?product_categoryID=<?php echo $footer_categories['product_categoryID']; ?>">
