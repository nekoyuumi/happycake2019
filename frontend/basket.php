                        ...
                        <?php if(isset($_SESSION['Cart']) && $_SESSION['Cart'] !=null){?>
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>運費</td>
                                        <th>$NT <?php if($total_price >= 2001){echo "0";}else{echo "150";}?></th>
                                    </tr>
                                   
                                    <tr class="total">
                                        <td>總金額</td>
                                        <th>$NT <?php if($total_price >= 2001){echo $total_price;}else{echo $total_price+150;} ?></th>
                                    </tr>
                                </tbody>
                            </table>
                        <?php }else{ ?>
