                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>運費</td>
                                        <th>$NT <?php if($_SESSION['order']['sub_total'] >= 2001){echo "0";}else{echo "150";}?></th>
                                    </tr>
                                   
                                    <tr class="total">
                                        <td>總金額</td>
                                        <th>$NT <?php if($_SESSION['order']['sub_total'] >= 2001){echo $_SESSION['order']['sub_total'];}else{echo $_SESSION['order']['total_price'];} ?></th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
