...
<?php require_once('template/navbar.php'); ?>
    <!-- *** NAVBAR END *** -->
<?php
    if($_SESSION['order']['sub_total'] >=2001){$total_price=$_SESSION['order']['sub_total'];}else{$total_price=$_SESSION['order']['total_price'];}
    ...
    if($_SESSION['order']['sub_total'] >=2001){
        $shipping = "0";
    }else{
        $shipping = "150";
    }
    ...
    $sth ->bindParam(":total", $total_price, PDO::PARAM_STR);
    $sth ->bindParam(":shipping", $shipping, PDO::PARAM_STR);
