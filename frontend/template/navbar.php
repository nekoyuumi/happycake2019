           ...
           <div class="navbar-collapse collapse" id="navigation">
               ...
               <ul class="nav navbar-nav navbar-left">
                   ...
                   <li class="dropdown yamm-fw">
                       <a href="product_list.php" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">產品介紹 <b class="caret"></b></a>
                           ...
                           <li>
                               <div class="yamm-content">
                                   <div class="row">
                                    ...
                                    <a href="product_list_filter.php?product_categoryID=<?php echo $product_categories['product_categoryID']; ?>">
