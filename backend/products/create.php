...
<?php if(isset($_POST['AddForm']) && $_POST['AddForm'] == "INSERT"){
  $sql= "INSERT INTO products ( product_categoryID, status, picture, name, description, price, created_at) VALUES ( :product_categoryID, :status, :picture, :name, :description, :price, :created_at)";
  $sth = $db ->prepare($sql);
        ...
        <div class="col-md-12 text-right">
          <form id="c_form-h" class="" method="post" action="create.php?product_categoryID=".<?php echo $_GET['product_categoryID']; ?> enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <div class="col-10">
                <input type="text" class="form-control" id="status" name="status" placeholder="預設>無,1>新商品,2>特價"> </div>
            </div>
            <div class="form-group row">
            ...
            <a class="btn btn-info" href="../products/list.php?product_categoryID=<?php echo $_GET['product_categoryID'] ?>">回上一頁</a>
