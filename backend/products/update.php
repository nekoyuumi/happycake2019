...
if (isset($_POST['EditForm']) && $_POST['EditForm'] == "UPDATE"){
  ...
  $sql= "UPDATE products SET price=:price, status=:status, picture=:picture, name=:name, description=:description, updated_at=:updated_at WHERE productID=:productID";
  $sth = $db ->prepare($sql);
        ...
        <div class="col-md-12 text-right">
          <form id="c_form-h" class="" method="post" action="update.php" enctype="multipart/form-data">
            <div class="form-group row"> <label for="picture" class="col-2 col-form-label">圖片</label>
              ...
              <img class="mb-2" src="../../uploads/products/<?php echo $one_products['picture'] ?>" width="200">
            ...
            <div class="form-group row">
              <label for="price" class="col-2 col-form-label">價錢</label>
              <div class="col-10">
                <input type="text" class="form-control" id="price" name="price" value="<?php echo $one_products['price']?>"> </div>
            </div>
            <div class="form-group row">
              <label for="status" class="col-2 col-form-label">標籤</label>
              <div class="col-10">
                <input type="text" class="form-control" id="status" name="status" value="<?php echo $one_products['status']?>"> </div>
            </div>
            <div class="form-group row">
