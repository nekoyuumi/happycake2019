...
if (isset($_POST['EditForm']) && $_POST['EditForm'] == "UPDATE"){
  ...
  $sql= "UPDATE news SET published_at=:published_at, picture=:picture, title=:title, content=:content, updated_at=:updated_at WHERE newsID=:newsID";
  $sth = $db ->prepare($sql);
        ...
        <div class="col-md-12 text-right">
          <form id="c_form-h" class="" method="post" action="update.php" enctype="multipart/form-data">
            <div class="form-group row"> <label for="picture" class="col-2 col-form-label">圖片</label>
              ...
              <img class="mb-2" src="../../uploads/news/<?php echo $one_news['picture'] ?>" width="200">
